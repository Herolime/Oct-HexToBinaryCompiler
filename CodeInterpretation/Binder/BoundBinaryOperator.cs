...
namespace OctAndHexToBinaryCompiler.CodeInterpretation.Binding
{
    internal sealed class BoundBinaryOperator
    {
        ...
        private static BoundBinaryOperator[] _operators =
        {
            ...
            new BoundBinaryOperator(SyntaxKind.MinusToken, BoundBinaryOperatorKind.Substraction, typeof(string)),
            new BoundBinaryOperator(SyntaxKind.StarToken, BoundBinaryOperatorKind.Multiplication, typeof(string)),
